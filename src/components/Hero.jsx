  ...
  return (
    <div className="flex flex-wrap items-center justify-between mt-20 mb-2 md:mb-10 px-2">
      <div className="w-full md:w-1/2 order-2 md:order-1">
        <p className="text-primary-color uppercase text-sm font-bold tracking-wide">Frontend Developer | Web developer</p>
        ...
        <p className="text-justify text-sm py-3 leading-7">
          Passionate web developer with 3+ years of experience in building functional, visually engaging apps. Skilled in ReactJS, TypeScript, Node.js, and GraphQL, focused on intuitive UX and transforming complex data into seamless experiences.
        </p>
